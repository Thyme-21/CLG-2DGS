...
def readColmapSceneInfo(path, images, eval, n_views=3, llffhold=8):
    ...
    scene_info = SceneInfo(point_cloud=pcd,
                           ...
                           ply_path=ply_path)
    print(f"[DEBUG] Total cams: {len(cam_infos)}, "
          f"Train cams: {len(train_cam_infos)}, "
          f"Test cams: {len(test_cam_infos)}, n_views={n_views}")
    if n_views > 0:
        print("[DEBUG] train subset indices:", idx_sub)
